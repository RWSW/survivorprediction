...
public class GetGroupUsersRESTFulRequest extends SpringAndroidSpiceRequest<String> {

    private String contactID = "";
    private String GET_MESSAGE = "/group/ids";

    public GetGroupUsersRESTFulRequest() {
        super(String.class);
    }
